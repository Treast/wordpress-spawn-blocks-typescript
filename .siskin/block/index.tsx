...
interface I$__1__$Props {
  background: boolean;
}

const edit = (props: BlockEditProps<I$__1__$Props>) => {
...
const save = (props: BlockEditProps<I$__1__$Props>) => {
...
const blockSettings: IBlockConfiguration<I$__1__$Props> = {
  apiVersion: 2,
